...
After reporting analysis findings, suggest: if no critical issues, run `/spec implement` to execute the tasks. If issues found, fix the affected artifacts first.
